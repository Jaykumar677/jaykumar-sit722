document.addEventListener('DOMContentLoaded', () => {
    ...
    const PRODUCT_API_BASE_URL = window._env_.PRODUCT_API;
    const ORDER_API_BASE_URL = window._env_.ORDER_API;
    const CUSTOMER_API_BASE_URL = window._env_.CUSTOMER_API;
